...
<head>
    ...
    <style>
        :root { --edu-green: #1a3a32; --soft-peach: #fdf0e6; }
        body { font-family: 'sans-serif'; background-color: var(--soft-peach); display: flex; align-items: center; justify-content: center; min-height: 100vh; margin: 0; }
        .reg-card { background: white; padding: 2.5rem; border-radius: 20px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.05); width: 100%; max-width: 450px; }
        .btn-reg { background-color: var(--edu-green); color: white; width: 100%; padding: 12px; border-radius: 10px; font-weight: 600; border: none; }
    </style>
</head>
<body>
    <div class="reg-card">
